...
<?php $this->start('tabs'); ?>
<li><?php echo $this->FileManager->link(__('Upload here'), array('controller' => 'file_managers', 'action' => 'upload'), $path); ?></li>
<li><?php echo $this->FileManager->link(__('Create directory'), array('controller' => 'file_managers', 'action' => 'create_directory'), $path); ?></li>
<li><?php echo $this->FileManager->link(__('Create file'), array('controller' => 'file_managers', 'action' => 'create_file'), $path); ?></li>
<?php $this->end(); ?>
...
<div class="directory-content">
	...
	<?php
		...
		foreach ($content['1'] AS $file) {
			$actions = $this->FileManager->link(__('Edit'), array('controller' => 'file_managers', 'action' => 'editfile'), $path.$file);
