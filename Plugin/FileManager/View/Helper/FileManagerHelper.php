 ...
 */
	public function linkDirectory($title, $path) {
		$output = $this->link($title, array('controller' => 'file_managers', 'action' => 'browse'), $path);
		return $output;
	}
 ...
 */
	public function linkFile($title, $path) {
		$output = "<a href='" . $this->Html->url(array('controller' => 'file_managers', 'action' => 'editfile')) . "?path=" . urlencode($path) . "'>{$title}</a>";
		return $output;
	}
 ...
 */
	public function linkUpload($title, $path) {
		$output = $this->link($title, array('controller' => 'file_managers', 'action' => 'upload'), $path);
		return $output;
	}
 ...
 */
	public function linkCreateDirectory($title, $path) {
		$output = $this->link($title, array('controller' => 'file_managers', 'action' => 'new'), $path);
		return $output;
	}
