...
(32, 'Hook.bootstraps', 'Settings,Comments,Contacts,Nodes,Meta,Menus,Users,Blocks,Taxonomy,FileManager,Wysiwyg,Ckeditor', '', '', '', 0, 24, ''),
(33, 'Comment.email_notification', '1', 'Enable email notification', '', '', 1, 25, ''),
(34, 'Access Control.multiColumn', '0', 'Allow login by username or email', '', 'checkbox', 1, 26, ''),
(34, 'Access Control.multiRole', '0', 'Enable Multiple Roles', '', 'checkbox', 1, 27, ''),
(35, 'Access Control.rowLevel', '0', 'Row Level Access Control', '', 'checkbox', 1, 28, ''),
(36, 'Access Control.autoLoginDuration', '+1 week', '"Remember Me" Duration', 'Eg: +1 day, +1 week. Leave empty to disable.', 'text', 1, 29, ''),
(37, 'Access Control.models', '', 'Models with Row Level Acl', 'Select models to activate Row Level Access Control on', 'multiple', 1, 30, 'multiple=checkbox
options={"Nodes.Node": "Node", "Blocks.Block": "Block", "Menus.Menu": "Menu", "Menus.Link": "Link"}');
(38, 'Site.maintenance_ip_whitelist', '192.168.1.1', 'Maintenance IP whitelist', 'Whitelisted IP-adresses to view website when it is in maintenance model, status is off (seperate ip''s with a comma)', 'text', 1, 6, '');
