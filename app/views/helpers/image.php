...
class ImageHelper extends Helper
{
  ...
  function resize($path, $width, $height, $aspect = true, $htmlAttributes = array(), $return = false) {
    ...
    $fullpath = ROOT.DS.APP_DIR.DS.WEBROOT_DIR.DS.$this->themeWeb.$uploadsDir.DS;
    //$url = $fullpath.$path;
    $url = ROOT.DS.APP_DIR.DS.WEBROOT_DIR.DS.$this->themeWeb.$path;
    ...
    $relfile = $this->webroot.$this->themeWeb.$uploadsDir.'/'.$this->cacheDir.'/'.$width.'x'.$height.'_'.basename($path); // relative file
