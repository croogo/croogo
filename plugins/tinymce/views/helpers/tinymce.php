 ...
 */
    public $settings = array(
        ...
        // Theme options
        'theme_advanced_buttons1' => 'bold,italic,underline,|,justifyleft,justifycenter,justifyright,justifyfull,|,bullist,numlist,outdent,indent,blockquote,|,link,unlink,anchor,image,charmap,emotions,iespell,media,code,|,forecolor,backcolor,|,search',
        'theme_advanced_buttons2' => 'formatselect,fontselect,fontsizeselect,|,tablecontrols,|,sub,sup,|,fullscreen',
