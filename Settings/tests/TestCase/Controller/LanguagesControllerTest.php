 ...
 */
    ...
    {
        parent::setUp();
        $this->LanguagesController = $this->generate('Settings.Languages', [
            'methods' => [
                'redirect',
            ],
            'components' => [
 ...
 */
    public function testAdminAdd()
    {
        ...
        $this->testAction('/admin/languages/add', [
            'data' => [
                'Language' => [
                    'title' => 'Bengali',
                    'alias' => 'ben',
 ...
 */
    ...
    {
        $this->expectFlashAndRedirect('The Language has been saved');
        $this->testAction('/admin/languages/edit/1', [
            'data' => [
                'Language' => [
                    'id' => 1,
 ...
 */
    public function testAdminDelete()
    {
        ...
        $hasAny = $this->LanguagesController->Language->hasAny([
            'Language.alias' => 'eng',
        ]);
 ...
 */
    public function testAdminMoveUp()
    {
        ...
        $list = $this->LanguagesController->Language->find('list', [
 ...
 */
    protected function _addLanguages()
    {
        ...
        $this->LanguagesController->Language->save([
            'title' => 'Bengali',
            'alias' => 'ben',
        ]);
        $this->LanguagesController->Language->create();
