...
class TermTest extends CroogoTestCase {
	...
	public function testSaveAndGetIdShouldReturnExsitingIdOfTermWhenSlugAlreadyExists() {
		$exisitingTermData = array(
			'title' => 'Uncategorized',
			'slug' => 'uncategorized',
			'description' => ''
	...
	public function testHasSlugChangedShouldTrhowExceptionOnInvalidId() {
		$this->setExpectedException('NotFoundException');
		$this->Term->hasSlugChanged('invalid', 'blah');
	}

	public function testEditShouldReturnsTrueWhenRecordSaved() {
